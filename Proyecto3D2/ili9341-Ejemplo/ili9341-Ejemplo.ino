...
unsigned long debounceDelay = 80; // Tiempo de rebote (ajústalo según tus necesidades)
...
unsigned long debounceDelay2 = 80; // Tiempo de rebote (ajústalo según tus necesidades)
//***************************************************************************************************************************************
...
//*****************************************************************************************************************************************
  ...
  LCD_Bitmap(0,0,320,240, temp);

  String tempV = "Temp ideal entre 36.5 y 37";
  LCD_Print(tempV, 5, 5, 1.8, 0xffff, 0x0000);

  String tempA = "Temp media entre 37 y 38";
  LCD_Print(tempA, 5, 20, 1.8, 0xffff, 0x0000);

  String tempR = "Temp peligrosa mayor a 38";
  LCD_Print(tempR, 5, 35, 1.8, 0xffff, 0x0000);
...
//**************************************************************************************************************************************************
     ...
     //MedESP32 = Serial2.readString();
       ...
       Serial.print(MedESP321);
       Serial.println(" °C");
       Serial.print('\n');
       String DatoP = "temperatura: ";
       
       DatoP += String(MedESP321);
       LCD_Print(DatoP, 20, 180, 2, 0xffff,0x0000);
       delay(1000);
       
       if (MedESP321>= 36.5 && MedESP321<= 37) {
        String tempI = "Temperatura ideal";
        LCD_Print(tempI, 20, 210, 2, 0xffff, 0x0000);
       }
        if (MedESP321< 36.5) {
        String tempB = "Temperatura baja";
        LCD_Print(tempB, 20, 210, 2, 0xffff, 0x0000);
       }
        if (MedESP321>= 37 && MedESP321<= 38) {
        String tempM = "Temperatura media";
        LCD_Print(tempM, 20, 210, 2, 0xffff, 0x0000);
       }
        if (MedESP321>38) {
        String tempV = "Temperatura elevada";
        LCD_Print(tempV, 20, 210, 2, 0xffff, 0x0000);
       }
       }
       else {
...
//**************************************************************************************************************************************************
      ...
      if (archivo) {
        ...
        Serial.print("Medición guardada:");
        Serial.print(MedESP321);
        Serial.println(" °C");
        Serial.print('\n');
        archivo.close();
